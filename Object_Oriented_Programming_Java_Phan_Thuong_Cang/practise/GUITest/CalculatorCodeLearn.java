...
public class CalculatorCodeLearn extends JFrame implements ActionListener { 
	...
	/*Hàm khởi tạo*/
	public CalculatorCodeLearn(String s)
	{ 
		super(s);
	...
	public static void main(String args[])
	{
		...
		CalculatorCodeLearn simpleCalculator = new CalculatorCodeLearn("SimpleCalculator");
